...
"i686-msys-thread-multi-64int-2.0.0(0.28053)" or
	die "Errno architecture (i686-msys-thread-multi-64int-2.0.0(0.28053)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
